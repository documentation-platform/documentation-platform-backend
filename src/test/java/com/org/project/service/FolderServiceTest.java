...
class FolderServiceTest {
    ...
    class UserFolderServiceTests {
        ...
        void setUp() {
            ...
            when(rootFolder.getUser()).thenReturn(testUser);

            parentFolder = Mockito.mock(Folder.class);
            when(parentFolder.getId()).thenReturn("parent_folder_id");
            when(parentFolder.getName()).thenReturn("Parent Folder");
    ...
    @Nested
    class OrganizationFolderServiceTests {
        ...
        void setUp() {
            ...
            when(parentOrganizationFolder.getName()).thenReturn("Parent Organization Folder");
            when(parentOrganizationFolder.getOrganization()).thenReturn(testOrganization);
            when(parentOrganizationFolder.getParentFolder()).thenReturn(rootFolder);
        }
